...
/**
 * Класс для демонстрации использования Comparable и Comparator с классом Person.
 */
public class Task40_CompareCustomObjects {
    /**
     * Точка входа для демонстрации сравнения и сортировки объектов Person.
     *
    ...
    public static void main(String[] args) {
        ...
        // Сравниваем объекты напрямую, используя их "естественный" порядок
        ...
        System.out.println("alice30 vs charlie30: " + Integer.signum(alice30.compareTo(charlie30))); // < 0 (-) (Alice < Charlie)
        System.out.println("charlie30 vs bob30: " + Integer.signum(charlie30.compareTo(bob30)));   // > 0 (+) (Charlie > Bob)
        System.out.println("bob30 vs alice30: " + Integer.signum(bob30.compareTo(alice30)));       // > 0 (+) (Bob > Alice)
        ...
        // Collections.sort() использует метод compareTo() объектов в списке
        ...
        // Создаем новый список, т.к. предыдущий уже отсортирован
        List<Person> peopleForAgeSort = new ArrayList<>(List.of(alice30, bob25, charlie30, bob30, alice25));
        // Используем метод sort списка и передаем экземпляр Comparator
        ...
        // (Порядок для 30-летних не гарантирован, зависит от стабильности сортировки)
